...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1815785482ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=payment">`naval`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=author">`naval`.`author`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=book">`naval`.`book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=downloads">`naval`.`downloads`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=cart">`naval`.`cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=category">`naval`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=customer">`naval`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=settings">`naval`.`settings`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naval&table=contact">`naval`.`contact`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="27306226312e695856747a7c2a47715e">
